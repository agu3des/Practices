...
> https://github.com/agu3des/Git.git
> 

Versionamento de código

De modo a alternar entre “versões do código”, de modo a evitar perda de dados por errros

O que é o git? É um sistema de versionamento de código, que guarda rresgistros como snapshots(fotos), do estado e da referêcia (caminho da versão)

Ele faz uma hash - registro 
